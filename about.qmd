...
Duffin, C., Branson, P., Rayson, M., Girolami, M., Cripps, E., Stemler, T., 2023. Exploring Model Misspecification in Statistical Finite Elements via Shallow Water Equations (preprint). [(arXiv link)](https://doi.org/10.48550/arXiv.2307.05334) [(code)](https://github.com/connor-duffin/sswe).
...
Akyildiz, Ö.D.$^*$, Duffin, C.$^*$, Sabanis, S., Girolami, M., 2022. Statistical Finite Elements via Langevin Dynamics. SIAM/ASA Journal on Uncertainty Quantification. [(link)](https://doi.org/10.1137/21M1463094) [(code)](https://github.com/connor-duffin/ula-statfem) ($^*$joint first authors).

Duffin, C., Cripps, E., Stemler, T., Girolami, M., 2022. Low-rank statistical finite elements for scalable model-data synthesis. Journal of Computational Physics 463. [(link)](https://doi.org/10.1016/j.jcp.2022.111261) [(code)](https://github.com/connor-duffin/low-rank-statfem).

Duffin, C., Cripps, E., Stemler, T., Girolami, M., 2021. Statistical finite elements for misspecified models. PNAS 118. [(link)](https://doi.org/10.1073/pnas.2015006118) [(code)](https://github.com/connor-duffin/statkdv-paper) [(UWA media release)](https://www.uwa.edu.au/news/Article/2021/January/New-system-to-advance-predictions-in-engineering) [(Cambridge media release)](https://www-smartinfrastructure.eng.cam.ac.uk/news/cambridge-academic-csic-redefines-finite-element-method-data-age).
